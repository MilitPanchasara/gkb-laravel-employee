                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('employees.update', [$employee->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fname" type="text" class="form-control @error('fname') is-invalid @enderror" name="fname" value="{{ $employee->first_name }}" required autocomplete="fname" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="lname" type="text" class="form-control @error('lname') is-invalid @enderror" name="lname" value="{{$employee->last_name}}" required autocomplete="lname">
